                      ...
                      >
                        <g clipPath="url(#clip0_1815_53330)">
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M4.444 40H35.556C36.7346 40 37.865 39.5318 38.6984 38.6984C39.5318 37.865 40 36.7346 40 35.556V4.444C40 3.26538 39.5318 2.13503 38.6984 1.30162C37.865 0.468206 36.7346 0 35.556 0L4.444 0C3.26538 0 2.13503 0.468206 1.30162 1.30162C0.468206 2.13503 0 3.26538 0 4.444L0 35.556C0 36.7346 0.468206 37.865 1.30162 38.6984C2.13503 39.5318 3.26538 40 4.444 40Z"
                            fill="#007EBB"
                          />
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                            d="M34.4437 34.4427H28.5077V24.3327C28.5077 21.5617 27.4547 20.0127 25.2607 20.0127C22.8737 20.0127 21.6267 21.6247 21.6267 24.3327V34.4427H15.9067V15.1837H21.6267V17.7777C21.6267 17.7777 23.3467 14.5957 27.4337 14.5957C31.5187 14.5957 34.4437 17.0897 34.4437 22.2497V34.4427ZM9.08169 12.6627C7.13369 12.6627 5.55469 11.0707 5.55469 9.10769C5.55469 7.14569 7.13369 5.55469 9.08169 5.55469C11.0307 5.55469 12.6087 7.14469 12.6087 9.10769C12.6087 11.0707 11.0307 12.6627 9.08169 12.6627ZM6.12869 34.4417H12.0937V15.1837H6.12869V34.4437V34.4417Z"
                            fill="white"
                          />
                        </g>
                        <defs>
