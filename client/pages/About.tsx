              ...
              <div className="flex w-full flex-col items-start">
                <div className="flex flex-col items-start w-full space-y-6">
                  <p className="text-[16px] leading-[24px] text-[#252525]">
                    I'm Herick Morais, a brazilian designer who discovered my passion for design as a child when I created my birthday invitations using 
                    PowerPoint on Windows XP. As I progressed, I embraced Photoshop and worked as a Graphic Designer for local businesses. Despite 
                    enjoying Visual Identity work, I yearned for the logical problem-solving aspects of product development, leading me to study Systems 
                    Analysis and Development.
                  </p>

                  <p className="text-[16px] leading-[24px] text-[#252525]">
                    I started working as a developer Front End and QA, for an insurance company in Australia, and although I used to like all the logical problem 
                    solving aspects involved, I found myself longing for Product Study and Definitions Aspects related Graphic Design role. It was when I got to 
                    know the area of UX Design and all the others Product Team roles, and I immediately started studying and delving deeper into the subject.
                  </p>

                  <p className="text-[16px] leading-[24px] text-[#252525]">
                    Through Courses and Mentoring, I became a UX/UI Designer that seeks to learn and improve every day using Heuristics and Information 
                    Architecture, together with Flows, Technology and Business Goals.
                  </p>
                </div>
              </div>
