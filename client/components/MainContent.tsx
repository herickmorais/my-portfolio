            ...
            >
              ...
              <motion.div className="flex gap-8" variants={itemVariants}>
                <motion.div
                  ...
                  className="w-full max-w-[444px] grow-0"
                >
              ...
              >
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-1/2 max-md:w-full max-md:ml-0">
                    <div
                      className="flex flex-col justify-start w-full items-center px-6"
                      style={{ backgroundColor: "rgba(208, 224, 224, 1)" }}
                    >
                      <div className="flex flex-row relative mt-5 w-full pb-8 justify-center items-center">
                        <img
                          loading="lazy"
              ...
              >
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-1/2 max-md:w-full max-md:ml-0">
                    <div
                      className="flex flex-col justify-start w-full items-center px-6"
                      style={{ backgroundColor: "rgba(206, 206, 206, 1)" }}
                    >
                      <div className="flex flex-row relative mt-5 w-full pb-8 justify-center items-center">
                        <img
                          loading="lazy"
